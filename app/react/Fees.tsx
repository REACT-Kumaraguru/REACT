...
export default function Fees() {
  return (
    <div>
      <h2 style={{ fontSize: "1 rem", color: "black", marginBottom: "1rem" }} className="text-2xl font-bold mb-4 text-rose-700">Fees & Support</h2>
      ...
      <h3 style={{ fontSize: "1 rem", color: "black", marginBottom: "1rem" }}className="text-xl font-semibold text-rose-700 mt-6 mb-2">Fellowship Tuition</h3>
      <p style={{ fontSize: "1 rem", color: "black", marginBottom: "1rem" }}className="mb-4 text-gray-700">
        The tuition fee for the REACT Fellowship is <strong>₹15,000</strong>. This investment enables:
      </p>
      ...
      <h3 style={{ fontSize: "1 rem", color: "black", marginBottom: "1rem" }}className="text-xl font-semibold text-rose-700 mb-2">Scholarships: Opportunity for All</h3>
      <p style={{ fontSize: "1 rem", color: "black", marginBottom: "1rem" }}className="mb-4 text-gray-700">
