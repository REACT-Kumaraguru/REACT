...
export default function Fees() {
  return (
    <div>
      ...
      <h3 className="text-xl font-semibold text-rose-700 mt-6 mb-2">Fee Structure</h3>
      <p className="mb-4 text-gray-700">
      ...
      <h3 className="text-xl font-semibold text-rose-700 mb-2">Scholarships & Support</h3>
      <p className="mb-4 text-gray-700">
      ...
      <p className="mb-2 text-gray-700 font-medium">Scholarships are available in the following tiers:</p>
      <ul className="list-disc list-inside text-gray-700 mb-4">
      ...
      <h3 className="text-xl font-semibold text-rose-700 mb-2">Value Beyond Cost</h3>
      <p className="mb-6 text-gray-700">
