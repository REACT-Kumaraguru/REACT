...
export default function Contact() {
  return (
    <main
      className="min-h-screen bg-black text-white px-6 py-12 md:px-24 font-sans bg-cover bg-center bg-no-repeat"
      style={{
        backgroundImage: "url('/mathbg.png')",
      }}
    >
      <h1 className="text-5xl font-bold text-center mb-12 text-white tracking-wide">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl p-8 shadow-2xl transition transform hover:scale-[1.02]">
          <h2 className="text-2xl font-semibold text-yellow-300 mb-4"> Key Contacts</h2>
        ...
        {/* Email & Socials */}
        <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl p-8 shadow-2xl transition transform hover:scale-[1.02]">
          <h2 className="text-2xl font-semibold text-yellow-300 mb-4">📨 Reach Us Online</h2>
          <div className="mb-6">
