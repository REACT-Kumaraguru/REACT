...
export default function Implement() {
  return (
    ...
    >
      <h3 style={{ fontSize: "22px", color: "#92400e", marginBottom: "1rem" }}> Implement & Transfer (1–3 Months)</h3>
      ...
      <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
        <li>✅ Deploy the prototype in the actual environment</li>
        <li>👀 Watch and listen to how users respond</li>
        <li>🧪 Test what works and what needs fixing</li>
      ...
      <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
        <li>🗂️ Create a record of your journey: sketches, notes, decisions, feedback</li>
        <li>🧾 File for IP (if needed): patents, copyrights, or trademarks</li>
      ...
      <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
        <li>🤝 Align values with your partner—social, ecological, and economic</li>
        <li>🛠️ Share responsibilities: Who builds? Who funds? Who owns?</li>
      ...
      <h4 className="text-lg font-semibold text-green-700 mb-2">🏁 Your Final Output Could Be:</h4>

      <ul className="list-disc list-inside text-gray-700 mb-6 space-y-1">
        <li>A working tool in the hands of users</li>
        <li>A policy brief adopted by decision-makers</li>
        <li>A startup-ready MVP</li>
